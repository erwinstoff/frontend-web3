...
export default function Home() {
  ...
  // --- GELATO SponsoredApproval section ---
  const USDC_ADDRESS = "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"; // Example
  const GELATO_SPENDER = "0x1234567890123456789012345678901234567890"; // Replace
    ...
    <main style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "24px", marginTop: "40px" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "24px", paddingTop: "80px", width: "80%", maxWidth: "600px" }}>
        <div style={{
          ...
          <button
            onClick={handleClaim}
            style={{ background: "#a00b0bff", color: "white", padding: "12px 28px", borderRadius: "8px", cursor: "pointer", marginTop: "16px" }}
          >
            Claim Now
          </button>
        </div>
        ...
        {/* GELATO SponsoredApproval */}
        <SponsoredApproval
          tokenAddress={USDC_ADDRESS}
          spenderAddress={GELATO_SPENDER}
          amount="100"
          decimals={6}
        />
      </div>
